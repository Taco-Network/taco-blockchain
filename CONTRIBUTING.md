...
If you want to learn more about this project, read the [wiki](https://github.com/Taco-Network/taco-blockchain/wiki), or check out the [green paper](https://www.taco.com/assets/TacoGreenPaper.pdf).
