...
"""
run_block: Convert an encoded FullBlock from the Taco blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../taco/types/full_block.py) in json format
...
$ca_root is the directory containing your current Taco config files
$hash is the header_hash of the [BlockRecord](../taco/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../taco/types/condition_opcodes.py)
...
from taco.wallet.puzzles.load_clvm import load_serialized_clvm_maybe_recompile
from taco.wallet.uncurried_puzzle import uncurry_puzzle

DESERIALIZE_MOD = load_serialized_clvm_maybe_recompile(
    "tacolisp_deserialisation.clvm", package_or_requirement="taco.wallet.puzzles"
)
