import { AlertDialog, Card, Flex, Loading, Dropzone, mojoToTacoLocaleString } from '@taco/core';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">{mojoToTacoLocaleString(props.balance)} TXTX</Typography>
        </Box>
      </Box>
    </Grid>
  );
