...
import { useSetCATNameMutation } from '@taco/api-react';
...
import { Tooltip, CardListItem, Flex, Link, useShowError } from '@taco/core';
...
export default function WalletTokenCard(props: WalletTokenCardProps) {
  ...
  const currentName = walletType === WalletType.STANDARD_WALLET ? 'Taco' : name;
