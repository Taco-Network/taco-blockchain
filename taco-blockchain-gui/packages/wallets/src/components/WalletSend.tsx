import { useGetSyncStatusQuery, useSendTransactionMutation, useFarmBlockMutation } from '@taco/api-react';
import {
  AdvancedOptions,
  Amount,
  ButtonLoading,
...
export default function WalletSend(props: SendCardProps) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      throw new Error(t`Cannot send taco to coloured address. Please enter a taco address.`);
    }
