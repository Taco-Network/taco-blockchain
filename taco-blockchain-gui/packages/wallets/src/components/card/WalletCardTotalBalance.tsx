...
import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@taco/api-react';
import styled from 'styled-components';
import WalletGraph from '../WalletGraph';
import { CardSimple, Flex, TooltipIcon } from '@taco/core';
          ...
          <Flex alignItems="center" gap={1}>
            ...
            <TooltipIcon>
              <Trans>
                ...
                This number is generally higher if you have a lot of transactions or canceled offers for XTX, CATs, or NFTs.
