import { AlertDialog, tacoToMojo } from '@taco/core';
...
export function CreateRLAdminWallet() {
  ...
  function create() {
    ...
    const tacoper = tacoToMojo(tacoper_input.value);
    ...
    // var fee = tacoToMojo(fee_input.value);
    // TODO(lipa): send fee to server
    // const fee_value = parseInt(Number(fee));
    dispatch(create_rl_admin_action(interval_value, tacoper_value, userpubkey, amount_value));
  }
