...
test('Confirm that User cannot send a TXTX fee greater then in Wallet', async () => {
  ...
  await page.locator('text=Fee *TXTX >> input[type="text"]').fill('10');
  ...
  await expect(page.locator('text=Pending Change0 TXTX')).toBeVisible();
});
