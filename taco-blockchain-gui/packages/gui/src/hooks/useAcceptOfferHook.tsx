import { OfferSummaryRecord } from '@taco/api';
import { useTakeOfferMutation } from '@taco/api-react';
import { AlertDialog, tacoToMojo, useOpenDialog, useShowError } from '@taco/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? tacoToMojo(fee) : new BigNumber(0);
