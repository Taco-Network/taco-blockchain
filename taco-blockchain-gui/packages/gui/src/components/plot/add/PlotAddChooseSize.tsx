import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@taco/core';
    ...
    <CardStep step={step} title={<Trans>Choose Plot Size</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Taco-Network/taco-blockchain/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
