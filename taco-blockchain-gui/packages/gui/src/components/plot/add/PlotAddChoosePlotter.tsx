...
import { CardStep, Select, StateColor } from '@taco/core';
import { useGetPlottersQuery } from '@taco/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort tacopos to the top of the list
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Taco Proof of Space plotter. If unsure,
            use the default Taco Proof of Space plotter.
        </Trans>
      </Typography>
