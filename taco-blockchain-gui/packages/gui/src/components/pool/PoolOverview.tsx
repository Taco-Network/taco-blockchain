...
import { Flex, UnitFormat, More, Table, mojoToTacoLocaleString, Suspender } from '@taco/core';
...
import { WalletStatus } from '@taco/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToTacoLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
