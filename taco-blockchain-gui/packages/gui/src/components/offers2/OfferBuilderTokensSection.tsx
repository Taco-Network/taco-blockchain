...
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@taco/core';
import { Tokens } from '@taco/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Taco Asset Tokens (CATs) are tokens built on top of XTX</Trans>}
