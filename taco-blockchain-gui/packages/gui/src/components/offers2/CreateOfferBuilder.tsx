...
import { useGetWalletsQuery, useCreateOfferForIdsMutation } from '@taco/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@taco/core';
...
type createDefaultValuesParams = {
  walletType?: WalletType; // CAT or STANDARD_WALLET (XTX), indicates whether a token or CAT has a default entry
...
export function createDefaultValues(params: createDefaultValuesParams): OfferBuilderData {
  ...
  return {
    ...
    offered: {
      ...
      xtx: walletType === WalletType.STANDARD_WALLET ? [{ amount: '' }] : [],
