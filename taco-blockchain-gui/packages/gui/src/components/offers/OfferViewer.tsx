...
import { useCheckOfferValidityMutation } from '@taco/api-react';
          ...
          >
            <Link
              onClick={(event: React.SyntheticEvent) =>
                handleLinkClicked(
                  event,
                  `https://www.tacoexplorer.com/blockchain/coin/${coin.parentCoinInfo}`,
                )
              }
            >
              {coin.parentCoinInfo}
          ...
          >
            <Link
              onClick={(event: React.SyntheticEvent) =>
                handleLinkClicked(
                  event,
                  `https://www.tacoexplorer.com/blockchain/puzzlehash/${coin.puzzleHash}`,
                )
              }
            >
              {coin.puzzleHash}
