import { Wallet, WalletType, type CATToken } from '@taco/api';
import { useGetCatListQuery, useGetWalletsQuery } from '@taco/api-react';
import { Select, useCurrencyCode } from '@taco/core';
...
type BuildAssetSelectorListParams = {
  ...
  tacoCurrencyCode: string;
};

function buildAssetSelectorList(params: BuildAssetSelectorListParams): WalletOfferAssetSelection[] {
  const { wallets, catList, rows, otherRows, selectedWalletId, tacoCurrencyCode } = params;
