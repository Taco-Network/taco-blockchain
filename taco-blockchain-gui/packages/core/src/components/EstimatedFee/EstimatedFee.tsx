import { useGetFeeEstimateQuery } from '@taco/api-react';
import { Fee, Flex, mojoToTacoLocaleString, useCurrencyCode, useLocale } from '@taco/core';
...
export default function EstimatedFee(props: FeeProps) {
  ...
  const txCostEstimates = {
    walletSendXTX: Math.floor(maxBlockCostCLVM / 1170),
    spendCATtx: 36382111,
  ...
  function formatEst(number, multiplier, locale) {
    ...
    const formatNum = mojoToTacoLocaleString(num, locale);
    return formatNum;
  }
