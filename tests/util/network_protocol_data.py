...
from taco.types.weight_proof import WeightProof, SubEpochData, SubEpochChallengeSegment, SubSlotData, RecentChainData
...
from taco.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, FoliageBlockData, TransactionsInfo

from taco.protocols import (
    farmer_protocol,
    full_node_protocol,
    harvester_protocol,
    introducer_protocol,
...
pool_target = PoolTarget(
    bytes32.from_hexstr("5593755c5604a1651c85700d2db91a2fa4d978fcd9d5bb9aa948fbf4d0093193"),
    uint32(421941852),
)
