...
class _AssertRuntime:
    ...
    Produces output of the following form.
        ...
        /home/altendky/repos/taco-blockchain/tests/core/full_node/test_performance.py:187
...
@contextlib.contextmanager
def closing_taco_root_popen(taco_root: TacoRoot, args: List[str]) -> Iterator[subprocess.Popen[Any]]:
    environment = {**os.environ, "TACO_ROOT": os.fspath(taco_root.path)}
