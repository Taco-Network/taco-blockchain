...
The workflows are located in [../.github/workflows/](https://github.com/superdutyf3/taco-network/tree/main/.github/workflows).
...
In the top tests directory, [testconfig.py](https://github.com/superdutyf3/taco-network/tree/main/tests/testconfig.py)
