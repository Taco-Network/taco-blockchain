...
async def test_nft_offer_with_fee(two_wallet_nodes: Any, trusted: Any) -> None:
    ...
    await time_out_assert(15, wallet_maker.get_confirmed_balance, maker_balance_pre + xtx_request - maker_fee)
    await time_out_assert(15, wallet_taker.get_confirmed_balance, taker_balance_pre - xtx_request - taker_fee)
    ...
    await time_out_assert(15, get_trade_and_status, TradeStatus.CONFIRMED, trade_manager_maker, trade_make)
    await time_out_assert(15, get_trade_and_status, TradeStatus.CONFIRMED, trade_manager_taker, trade_take)
    await time_out_assert(15, wallet_maker.get_confirmed_balance, maker_balance_pre - xtx_offered - maker_fee)
    await time_out_assert(15, wallet_taker.get_confirmed_balance, taker_balance_pre + xtx_offered - taker_fee)
...
async def test_nft_offer_nft_for_nft(two_wallet_nodes: Any, trusted: Any) -> None:
    ...
    metadata_2 = Program.to(
        [
            ("u", ["https://www.taco-network.net/image2.html"]),
