...
class TestOfferLifecycle:
    ...
    async def test_complex_offer(self, setup_sim):
        ...
        try:
            ...
            taco_announcements: List[Announcement] = Offer.calculate_announcements(taco_requested_payments)
            taco_secured_bundle: SpendBundle = self.generate_secure_bundle(taco_coins, taco_announcements, 1000)
            taco_offer = Offer(taco_requested_payments, taco_secured_bundle)
            ...
            new_offer = Offer.aggregate([taco_offer, red_offer])
