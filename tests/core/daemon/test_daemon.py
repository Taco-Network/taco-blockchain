...
from taco.daemon.keychain_server import DeleteLabelRequest, SetLabelRequest
from taco.daemon.server import WebSocketServer, service_plotter
...
from taco.util.keychain import KeyData
from taco.daemon.keychain_server import GetKeyRequest, GetKeyResponse, GetKeysResponse
...
from taco.simulator.time_out_assert import time_out_assert_custom_interval, time_out_assert
...
def mock_daemon_with_services():
    ...
    return Daemon(
        services={
            ...
            "taco_plotter": [Service(True), Service(True)],
        },
        connections={},
    )
