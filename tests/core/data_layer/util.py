...
from taco.data_layer.data_layer_util import NodeType, Side, Status
...
class TacoRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["TACO_ROOT"] = os.fspath(self.path)
        kwargs["env"]["TACO_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("taco"),
            "--root-path",
            self.path,
            *args,
        ]
