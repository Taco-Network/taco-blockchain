...
from taco.simulator.block_tools import BlockTools, create_block_tools_async
from taco.simulator.full_node_simulator import FullNodeSimulator
from taco.simulator.simulator_protocol import FarmNewBlockProtocol, GetAllCoinsProtocol, ReorgProtocol
...
from taco.simulator.setup_nodes import SimulatorsAndWallets, setup_simulators_and_wallets, setup_full_system
from taco.simulator.setup_services import setup_full_node
...
class TestSimulation:
    ...
    async def test_simulation_1(self, simulation, extra_node, self_hostname):
        ...
        server1: TacoServer = node1.full_node.server
        ...
        server3: TacoServer = node3.full_node.server
