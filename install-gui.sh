...
# https://github.com/Taco-Network/taco-blockchain/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `taco version` to version property of GUI's package.json
