...
from taco.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
...
from taco.server.ws_connection import NodeType, ProtocolMessageTypes, WSTacoConnection, make_msg
from taco.util.generator_tools import list_to_batches
from taco.util.ints import int16, uint32, uint64
...
class Sender:
    ...
    _connection: Optional[WSTacoConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSTacoConnection) -> None:
