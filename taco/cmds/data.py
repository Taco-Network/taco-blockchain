...
def create_fee_option() -> Callable[[FC], FC]:
    return click.option(
        "-m",
        "--fee",
        help="Set the fees for the transaction, in XTX",
        type=str,
        default=None,
        show_default=True,
        required=False,
...
def create_data_store(
    ...
    from taco.cmds.data_funcs import create_data_store_cmd
...
def get_value(
    ...
    from taco.cmds.data_funcs import get_value_cmd
...
def update_data_store(
    ...
    from taco.cmds.data_funcs import update_data_store_cmd
...
def get_keys(
    ...
    from taco.cmds.data_funcs import get_keys_cmd
...
def get_keys_values(
    ...
    from taco.cmds.data_funcs import get_keys_values_cmd
...
def get_root(
    ...
    from taco.cmds.data_funcs import get_root_cmd
...
def subscribe(
    ...
    from taco.cmds.data_funcs import subscribe_cmd
...
def remove_subscription(
    ...
    from taco.cmds.data_funcs import remove_subscriptions_cmd
...
def unsubscribe(
    ...
    from taco.cmds.data_funcs import unsubscribe_cmd
...
def get_kv_diff(
    ...
    from taco.cmds.data_funcs import get_kv_diff_cmd
...
def get_root_history(
    ...
    from taco.cmds.data_funcs import get_root_history_cmd
...
def add_missing_files(ids: Optional[str], overwrite: bool, foldername: Optional[str], data_rpc_port: int) -> None:
    from taco.cmds.data_funcs import add_missing_files_cmd
...
def add_mirror(id: str, amount: int, urls: List[str], fee: Optional[str], data_rpc_port: int) -> None:
    from taco.cmds.data_funcs import add_mirror_cmd
...
def delete_mirror(coin_id: str, fee: Optional[str], data_rpc_port: int) -> None:
    from taco.cmds.data_funcs import delete_mirror_cmd
...
def get_mirrors(id: str, data_rpc_port: int) -> None:
    from taco.cmds.data_funcs import get_mirrors_cmd
...
def get_subscriptions(data_rpc_port: int) -> None:
    from taco.cmds.data_funcs import get_subscriptions_cmd
...
def get_owned_stores(data_rpc_port: int) -> None:
    from taco.cmds.data_funcs import get_owned_stores_cmd
...
def get_sync_status(
    ...
    from taco.cmds.data_funcs import get_sync_status_cmd
