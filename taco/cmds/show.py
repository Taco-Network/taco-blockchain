...
from taco.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'taco show -c' has been renamed to 'taco peer -c' ")
    if add_connection != "":
        print("'taco show -a' has been renamed to 'taco peer -a' ")
    if remove_connection != "":
        print("'taco show -r' has been renamed to 'taco peer -r' ")
    if wallet_rpc_port is not None:
        print("'taco show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
