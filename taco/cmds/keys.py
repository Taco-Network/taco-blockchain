...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Taco versions use "
...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Taco keyring")
@click.pass_context
...
@click.option("--prefix", "-x", help="Address prefix (xtx for mainnet, txtx for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
