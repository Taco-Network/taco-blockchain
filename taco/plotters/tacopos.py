"""
NOTE: This contains duplicate code from `taco.cmds.plots`.
After `taco plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
from taco.plotting.util import add_plot_directory, validate_plot_size

log = logging.getLogger(__name__)


def get_tacopos_install_info() -> Optional[Dict[str, Any]]:
    tacopos_version: str = pkg_resources.get_distribution("chiapos").version
    return {"display_name": "Taco Proof of Space", "version": tacopos_version, "installed": True}
