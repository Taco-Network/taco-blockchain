...
from taco.plotting.util import PlotInfo, parse_plot_info
from taco.protocols import harvester_protocol
from taco.protocols.farmer_protocol import FarmingInfo
from taco.protocols.harvester_protocol import Plot, PlotSyncResponse
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSTacoConnection
    ):
        """
