...
from taco.data_layer.data_layer_wallet import Mirror, SingletonRecord
...
class WalletRpcClient(RpcClient):
    ...
    async def nft_mint_bulk(
        ...
        xtx_coins: Optional[List[Dict]] = None,
        xtx_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xtx_coins": xtx_coins,
            "xtx_change_target": xtx_change_target,
