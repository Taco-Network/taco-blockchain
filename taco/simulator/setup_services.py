...
from taco.cmds.init_funcs import init
from taco.consensus.constants import ConsensusConstants
from taco.daemon.server import WebSocketServer, daemon_launch_lock_path
from taco.data_layer.data_layer_api import DataLayerAPI
from taco.protocols.shared_protocol import Capability, capabilities
from taco.server.start_data_layer import create_data_layer_service
from taco.server.start_farmer import create_farmer_service
from taco.server.start_full_node import create_full_node_service
from taco.server.start_harvester import create_harvester_service
from taco.server.start_introducer import create_introducer_service
from taco.server.start_timelord import create_timelord_service
from taco.server.start_wallet import create_wallet_service
from taco.simulator.block_tools import BlockTools
from taco.simulator.keyring import TempKeyring
from taco.simulator.start_simulator import create_full_node_simulator_service
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["xtx_spam_amount"] = xtx_spam_amount
...
async def setup_farmer(
    ...
    service_config["xtx_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "xtx")
