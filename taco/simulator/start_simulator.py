...
from taco.server.start_service import Service, async_run
from taco.simulator.simulator_full_node_rpc_api import SimulatorFullNodeRpcApi
from taco.types.blockchain_format.sized_bytes import bytes32
from taco.util.bech32m import decode_puzzle_hash
from taco.util.taco_logging import initialize_logging
from taco.util.config import load_config_cli, override_config, load_config
from taco.util.default_root import DEFAULT_ROOT_PATH
from taco.simulator.block_tools import BlockTools, test_constants
...
async def async_main(test_mode: bool = False, automated_testing: bool = False, root_path: Path = DEFAULT_ROOT_PATH):
    ...
    if "simulator" in config:
        ...
        overrides = {
            ...
            "full_node.introducer_peer": {"host": "127.0.0.1", "port": 518735},
        }
