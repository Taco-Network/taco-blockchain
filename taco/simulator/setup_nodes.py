...
from taco.simulator.block_tools import BlockTools, create_block_tools_async, test_constants
from taco.simulator.full_node_simulator import FullNodeSimulator
from taco.simulator.keyring import TempKeyring
from taco.simulator.setup_services import (
    setup_daemon,
    setup_farmer,
    setup_full_node,
    setup_harvester,
...
SimulatorsAndWallets = Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, TacoServer]], BlockTools]
...
) -> AsyncGenerator[Tuple[FullNodeAPI, FullNodeAPI, TacoServer, TacoServer, BlockTools], None]:
    """
...
) -> AsyncGenerator[Tuple[FullNodeAPI, WalletNode, TacoServer, TacoServer, BlockTools], None]:
