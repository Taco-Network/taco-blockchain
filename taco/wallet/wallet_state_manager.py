...
from taco.protocols.wallet_protocol import CoinState, PuzzleSolutionResponse, RespondPuzzleSolution
...
from taco.util.config import process_config_start_method
...
from taco.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_wallet_sk_unhardened
from taco.wallet.did_wallet.did_info import DID_HRP
...
from taco.wallet.util.wallet_sync_utils import last_change_height_cs
...
from taco.wallet.wallet_weight_proof_handler import WalletWeightProofHandler
...
class WalletStateManager:
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSTacoConnection, fork_height: Optional[uint32]
    ) -> None:
