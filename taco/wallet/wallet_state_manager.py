...
from taco.consensus.coinbase import farmer_parent_id, pool_parent_id
from taco.consensus.constants import ConsensusConstants
from taco.data_layer.data_layer_wallet import DataLayerWallet
from taco.data_layer.dl_wallet_store import DataLayerStore
...
from taco.wallet.cat_wallet.cat_utils import construct_cat_puzzle, match_cat_puzzle
from taco.wallet.cat_wallet.cat_wallet import CATWallet
from taco.wallet.db_wallet.db_wallet_puzzles import MIRROR_PUZZLE_HASH
...
from taco.wallet.did_wallet.did_wallet_puzzles import DID_INNERPUZ_MOD, create_fullpuz, match_did_puzzle
from taco.wallet.key_val_store import KeyValStore
from taco.wallet.nft_wallet.nft_info import NFTWalletInfo
from taco.wallet.nft_wallet.nft_puzzles import get_metadata_and_phs, get_new_owner_did
from taco.wallet.nft_wallet.nft_wallet import NFTWallet
from taco.wallet.nft_wallet.uncurry_nft import UncurriedNFT
from taco.wallet.notification_manager import NotificationManager
from taco.wallet.outer_puzzles import AssetType
from taco.wallet.puzzle_drivers import PuzzleInfo
from taco.wallet.puzzles.cat_loader import CAT_MOD, CAT_MOD_HASH
...
from taco.wallet.util.address_type import AddressType
from taco.wallet.util.compute_hints import compute_coin_hints
from taco.wallet.util.transaction_type import TransactionType
from taco.wallet.util.wallet_sync_utils import last_change_height_cs, PeerRequestException
...
from taco.wallet.wallet_retry_store import WalletRetryStore
...
class WalletStateManager:
    ...
    async def determine_coin_type(
        self, peer: WSTacoConnection, coin_state: CoinState, fork_height: Optional[uint32]
    ...
    async def filter_spam(self, new_coin_state: List[CoinState]) -> List[CoinState]:
        xtx_spam_amount = self.config.get("xtx_spam_amount", 1000000)
        ...
        small_unspent_count = await self.coin_store.count_small_unspent(xtx_spam_amount)
        ...
        for cs in new_coin_state:
            ...
            if (
                ...
                and cs.coin.amount < xtx_spam_amount
    ...
    async def get_minter_did(self, launcher_coin: Coin, peer: WSTacoConnection) -> Optional[bytes32]:
        # Get minter DID
