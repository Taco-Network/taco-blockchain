...
from taco.types.weight_proof import WeightProof, SubEpochData
...
from taco.util.keychain import KeyringIsLocked, Keychain
from taco.util.path import mkdir, path_from_root
from taco.wallet.util.new_peak_queue import NewPeakQueue, NewPeakQueueTypes, NewPeakItem
    ...
    def initialize_wallet_peers(self):
        ...
        if self.wallet_peers is None and connect_to_unknown_peers and not testing:
            self.wallet_peers = WalletPeers(
                ...
                self.config.get("dns_servers", ["dns-introducer.taco.us"]),
