...
from taco.wallet.trading.offer import OFFER_MOD, NotarizedPayment, Offer
...
class NFTWallet:
    ...
    async def coin_added(self, coin: Coin, height: uint32, in_transaction: bool) -> None:
        ...
        full_nodes: Dict[bytes32, WSTacoConnection] = server.connection_by_type.get(NodeType.FULL_NODE, {})
