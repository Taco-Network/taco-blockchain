...
from taco.wallet.nft_wallet.nft_info import NFTCoinInfo, NFTInfo
from taco.wallet.nft_wallet.uncurry_nft import UncurriedNFT
from taco.wallet.puzzles.load_clvm import load_clvm
from taco.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import solution_for_conditions
...
def metadata_to_program(metadata: Dict[bytes, Any]) -> Program:
    """
    Convert the metadata dict to a Tacolisp program
    :param metadata: User defined metadata
    :return: Tacolisp program
    """
    kv_list = []
...
def program_to_metadata(program: Program) -> Dict[bytes, Any]:
    ...
    :param program: Tacolisp program contains the metadata
