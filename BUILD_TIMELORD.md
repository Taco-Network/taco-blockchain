...
required to run a [Timelord](https://github.com/TacoNetwork/taco-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/TacoNetwork/taco-blockchain/blob/main/install-timelord.sh)
