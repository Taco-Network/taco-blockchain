...
required to run a [Timelord](https://github.com/superdutyf3/taco-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/superdutyf3/taco-blockchain/blob/main/install-timelord.sh)
