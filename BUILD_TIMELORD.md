...
required to run a [Timelord](https://github.com/BTCgreen-Network/taco-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/BTCgreen-Network/taco-blockchain/blob/main/install-timelord.sh)
